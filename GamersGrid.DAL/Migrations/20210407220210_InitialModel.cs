...
namespace GamersGrid.DAL.Migrations
{
    public partial class InitialModel : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GameAccounts_VideoGames_GameId",
                        column: x => x.GameId,
            ...
            migrationBuilder.CreateTable(
                name: "GameAccountStats",
                columns: table => new
                {
                    GameAccountId = table.Column<int>(type: "int", nullable: false),
                    KDA = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GameAccountStats", x => x.GameAccountId);
                    table.ForeignKey(
                        name: "FK_GameAccountStats_GameAccounts_GameAccountId",
