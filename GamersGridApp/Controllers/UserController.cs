...
namespace GamersGridApp.Controllers
{
    public class UserController : Controller
    {
        ...
        public ActionResult ProfilePage(int? userid)
        {
            ...
            var currentLoggedUser = unitOfWork.Users.GetLoggedUser(loggedUserId);

            //var user = (userid == null) ? currentLoggedUser : context.GamersGridUsers.SingleOrDefault(u => u.ID == userid);
            var user = (userid == null) ? currentLoggedUser : unitOfWork.Users.GetUser(userid);
        ...
        public ActionResult Customize()
        {
            ...
            //    .SingleOrDefault();
            var ggtUser = unitOfWork.Users.GetLoggedUser(aspNetUserID);
            ...
            var userGameRelationLol = unitOfWork.UserGames.GetUserGameRelationWithExistingGame(lolId, ggtUser.ID);
            var userGameRelationDota = unitOfWork.UserGames.GetUserGameRelationWithExistingGame(dotaId, ggtUser.ID);
            var userGameRelationOverwatch = unitOfWork.UserGames.GetUserGameRelationWithExistingGame(overwatchId, ggtUser.ID);
        ...
        public ActionResult Save(UserFormEditViewModel viewmodel, HttpPostedFileBase file)
        {
            ...
            var userContent = unitOfWork.Users.GetUser(viewmodel.ID);
            userContent.Update(
        ...
        public ActionResult PostMessageEdit()
        {
            ...
            var otherUsers = unitOfWork.Users.GetOtherUsers(appUserId);
        ...
        public ActionResult PostMessageSave(PostMessageViewModel viewModel)
        {
            ...
            var posterid = unitOfWork.Users.GetUserIdBasedOnAppID(appUserId);
            //context.UserPostings.Add(new UserPosting(viewModel.PostingMessage, viewModel.OwnerId, posterid));
            unitOfWork.Users.AddUserPost(new UserPosting(viewModel.PostingMessage, viewModel.OwnerId, posterid));
            unitOfWork.Complete();
